...
class MailTemplate(models.Model):
    ...
    report_template_ids = fields.Many2many('ir.actions.report.xml',
    ...
    def generate_email(self, res_ids, fields=None):
        ...
        for template, template_res_ids in templates_to_res_ids.iteritems():
            ...
            if template.report_template or template.report_template_ids:
                attachments = []
                rp_templates = template.report_template + template.report_template_ids
                for report in rp_templates:
